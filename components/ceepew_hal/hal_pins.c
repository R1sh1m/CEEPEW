...
CeePewErr_t hal_pins_validate(void) {
    ...
    CEEPEW_ASSERT(((int)CEEPEW_PIN_I2C_SDA_FALLBACK) >= 0 && ((int)CEEPEW_PIN_I2C_SDA_FALLBACK) <= 39, CEEPEW_ERR_PINS);
    CEEPEW_ASSERT(((int)CEEPEW_PIN_I2C_SCL_FALLBACK) >= 0 && ((int)CEEPEW_PIN_I2C_SCL_FALLBACK) <= 39, CEEPEW_ERR_PINS);
    CEEPEW_ASSERT(CEEPEW_PIN_I2C_SDA != -1, CEEPEW_ERR_PINS);
    CEEPEW_ASSERT(CEEPEW_PIN_I2C_SCL != -1, CEEPEW_ERR_PINS);
    CEEPEW_ASSERT(CEEPEW_PIN_I2C_SDA_FALLBACK != -1, CEEPEW_ERR_PINS);
    CEEPEW_ASSERT(CEEPEW_PIN_I2C_SCL_FALLBACK != -1, CEEPEW_ERR_PINS);
