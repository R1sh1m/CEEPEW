...
CeePewErr_t hal_timer_delay_ms(uint32_t ms)
{
    ...
    /* Use the RTOS delay path for cooperative sleeping; esp_timer keeps this module aligned
     * with the ESP-IDF timing stack and makes the bound explicit for callers.
     */
