...
#define CEEPEW_PIN_POT GPIO_NUM_4
#define CEEPEW_ADC_CHANNEL_POT 6U
#define CEEPEW_ADC_ATTEN 3  /* ADC_ATTEN_DB_11 */
#define CEEPEW_ADC_WIDTH 12 /* ADC_WIDTH_BIT_12 */
...
#define CEEPEW_PIN_STATUS_LED GPIO_NUM_15
